...
function PrivacyPolicy() {
  return (
    <>
 <SeoMeta
  title="Privacy Policy of Maruti Cars | Popular Maruti"
  ...
  canonicalUrl="https://saboomaruti.in/maruti-new-brezza-on-road-price-in-hyderabad"
  ...
  twitterUrl="https://www.saboomaruti.in/maruti-swift-car-on-road-price-in-hyderabad"
/>
      ...
      <div className="container px-5 mx-auto">
        ...
        <div className="my-4 space-y-1">
          <h5 className="font-semibold">
            Popular RKS Maruti Suzuki Statement of Privacy Policy
          </h5>
          <p className="text-sm">
        ...
        <div className="my-4 space-y-1">
          ...
          <br></br>
          <p className="text-sm">
            I, hereby authorize Popular RKS Pvt Ltd., to contact me. It will
