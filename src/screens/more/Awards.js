...
/>
      ...
      <div className='bg-gray-100'>
        <div className='container grid grid-cols-1 mx-auto sm:grid-cols-2 lg:mt-16'>
          <img
          ...
          <div className='my-auto text-center' id='awards'>
            <p className='text-2xl font-semibold text-red-600 uppercase'>
      ...
      <div className='container grid grid-cols-1 gap-6 px-5 mx-auto my-10 md:grid-cols-2 lg:grid-cols-4'>
        {awardsData.map((award, index) => (
          <div
            className='overflow-hidden border border-gray-200 rounded-lg shadow-lg'
            key={index}
          >
            <img
              src={award.img}
            ...
            />
            <div className='p-4'>
              <p className='mb-2 font-medium text-center text-gray-800 text-md'>
                {award.title}
              </p>
            </div>
          </div>
