...
const PriceList = () => {
  ...
  return (
    <div className='header'>
      ...
      <div className='py-6 bg-blue-100 md:py-12'>
        <div className='container px-4 mx-auto sm:px-8'>
          <h1 className='block my-auto text-3xl text-center font-extralight'>
            Arena Cars
          </h1>
          <div className='py-2'>
            {/* <div>
            ...
            <div className='px-4 py-2 overflow-x-auto lg-mx-2 sm:-mx-8 sm:px-8'>
              ...
              <h1 className='block py-6 text-3xl text-center font-extralight'>
                Nexa Cars
              </h1>
              <NexaPriceList />
            </div>
  ...
  return (
    <div className='container px-2 mx-auto md:flex md:items-center'>
      ...
      <div className='py-2'>
        ...
        <p className='p-2 font-thin text-red-600'>
