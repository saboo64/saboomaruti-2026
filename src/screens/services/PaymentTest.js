...
const PaymentTest = () => {
  ...
  return (
    <>
      <Header />
      <div></div>
      <div className="container py-5 mx-auto rounded-lg" id="payments">
        <div className="mt-4 bg-gray-100 rounded-lg md:mt-0 p-7 ">
          <div className="items-center max-w-screen-xl gap-6 px-2 py-6 mx-auto xl:gap-14 md:grid md:grid-cols-1 sm:py-14 lg:px-4">
            {/* <img
              src='https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/payment-system/saboo-rks-qrcode.webp'
              className='w-96'
              alt='dashboard'
            /> */}
            <div className="mt-3 mb-2 bg-gray-100 rounded-lg md:mt-0">
              <h3 className="mt-6 text-4xl font-extrabold tracking-tight text-center text-gray-900 dark:text-white">
                Bank Details
              </h3>
            ...
            <div className="col-span-2 p-4 overflow-hidden shadow sm:rounded-md">
              <form
                id="arenaCarEnq2"
                action={
